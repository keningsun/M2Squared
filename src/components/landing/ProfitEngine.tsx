...
const ProfitEngine: React.FC = () => {
  ...
  return (
    <section className="bg-[rgba(237,237,240,1)] self-stretch flex w-full flex-col items-center mt-[123px] px-20 py-20 max-md:max-w-full max-md:mt-10 max-md:px-5">
      <div className="flex w-[1240px] max-w-full flex-col">
